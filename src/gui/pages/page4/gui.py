...
class Page4(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.page4_entry_2.insert('1', '21')
        self.page4_entry_2.place(
            x=486.0,
            y=241.0,
            width=321.0,
            height=59.0
    ...
    def ignore(self):
        self.parent.data["noftp"].set(True)
        self.parent.change_page("page5")

    def next_page(self):
        ip_address = self.page4_entry_1.get()
        port = self.page4_entry_2.get()
        self.parent.data["noftp"].set(False)
        self.parent.data["ip_address"].set(ip_address)
        self.parent.data["port"].set(port)
